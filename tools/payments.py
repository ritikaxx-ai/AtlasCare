...
Two-layer refund safety:
  Layer 1 (guardrail.py) — blocks > ₹25K before any planning starts (pre-LLM)
  Layer 2 (here)         — hard cap inside execute_refund._execute as final backstop
